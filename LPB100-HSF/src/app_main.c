...
#if defined(DEEVICE_LUMITEK_P1)
#define DEVICE_MODUAL_TYPE		HFM_TYPE_LPT100
const int hf_gpio_fid_to_pid_map_table[HFM_MAX_FUNC_CODE]=
{
	...
	HFM_NOPIN,		//HF_M_PIN(18),	//HFGPIO_F_EXTRA_SWITCH
...
#define DEVICE_MODUAL_TYPE		HFM_TYPE_LPB100
const int hf_gpio_fid_to_pid_map_table[HFM_MAX_FUNC_CODE]=
{
	HF_M_PIN(2),	//HFGPIO_F_JTAG_TCK
	...
	//USER_DEFINE
	HF_M_PIN(18),	//HFGPIO_F_RELAY_1
	HF_M_PIN(20),	//HFGPIO_F_RELAY_2
	HF_M_PIN(23),	//HFGPIO_F_SWITCH
	HF_M_PIN(40),	//HFGPIO_F_CF
	HF_M_PIN(43),	//HFGPIO_F_WIFI_LED
	HF_M_PIN(44),	//HFGPIO_F_RELAY_LED
	HF_M_PIN(42),	//HFGPIO_F_KEY
};
...
const int hf_gpio_fid_to_pid_map_table[HFM_MAX_FUNC_CODE]=
{
	...
	HF_M_PIN(12),	//	HFGPIO_F_BUZZER
	HF_M_PIN(11),	//	HFGPIO_F_SWITCH
	HF_M_PIN(39),	//HFGPIO_F_SWITCH_2
#ifdef EXTRA_SWITCH_SUPPORT
	HF_M_PIN(18),	//	HFGPIO_F_EXTRA_SWITCH
	HF_M_PIN(41),	//	HFGPIO_F_EXTRA_SWITCH_2
#endif
...
const int hf_gpio_fid_to_pid_map_table[HFM_MAX_FUNC_CODE]=
{
	...
	HF_M_PIN(12),	//HFGPIO_F_RESET
	HF_M_PIN(11),	//HFGPIO_F_SDO_0
	HF_M_PIN(20),	//HFGPIO_F_SDO_1
	HF_M_PIN(15),	//HFGPIO_F_SDO_2
	HF_M_PIN(18),	//HFGPIO_F_SWITCH
	HF_M_PIN(43),	//HFGPIO_F_WIFI_LED
	HF_M_PIN(42),	//HFGPIO_F_KEY
};
...
const int hf_gpio_fid_to_pid_map_table[HFM_MAX_FUNC_CODE]=
{
	...
	HF_M_PIN(12),	//	HFGPIO_F_KEY
	HF_M_PIN(11),	//	HFGPIO_F_WIFI_LED
	HF_M_PIN(18),	//	HFGPIO_F_SWITCH
};
...
#define DEVICE_MODUAL_TYPE		HFM_TYPE_LPT200
const int hf_gpio_fid_to_pid_map_table[HFM_MAX_FUNC_CODE]=
{
	HF_M_PIN(2),	//HFGPIO_F_JTAG_TCK
	HF_M_PIN(3),	//HFGPIO_F_JTAG_TDO
...
int USER_FUNC app_main (void)
{
	...
	if(hfgpio_fmap_check(DEVICE_MODUAL_TYPE)!=0)
	{
		while(1)
		{
