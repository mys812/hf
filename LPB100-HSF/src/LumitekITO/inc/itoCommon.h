...
#elif defined(DEEVICE_LUMITEK_P3) || defined(DEEVICE_LUMITEK_P6) || defined(DEEVICE_LUMITEK_P5)
...
#define MAX_RESEND_COUNT			4		//4´Î
#define MAX_FAILD_COUNT				4
#define MAX_RESEND_INTERVAL			8		//8Ãë
...
{
	RESET_FOR_SMARTLINK,
	RESET_FOR_SMARTLINK_OK,
	RESET_FOR_UPGRADE,
	RESET_FOR_FACTORY_TEST,
	RESET_FOR_NORMAL
} DEVICE_RESET_TYPE;
